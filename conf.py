...
SITE_URL = "https://tauspectral.github.io/"
SITE_URL = "/"
...
NAVIGATION_LINKS = {
  DEFAULT_LANG: (
    # ("link://post_path/posts", "Posts"), # +++ does not work
    ("/posts/", "Posts"),
    ("/tags/", "Tags"),
    ("/archive/", "Archive"),
    ("link://index_rss", "RSS"),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license} - Last updated on December 2018'
